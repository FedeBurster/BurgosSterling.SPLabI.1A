...
/** \brief Carga los campos infectados,recuperados y muertos, luego devuelve una lista nueva
 *
 * \param this
 * \param pFunc
 * \return lista con datos cargados
 *
 */
...
/** \brief Filtra los contenidos de una lista LinkedList y crea una nueva lista
 *
